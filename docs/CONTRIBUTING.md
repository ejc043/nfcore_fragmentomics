...
# `ejc043/nfcore_fragmentomics`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving ejc043/nfcore_fragmentomics.

This page describes the recommended nf-core way to contribute to both ejc043/nfcore_fragmentomics and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of ejc043/nfcore_fragmentomics.
...
- [ ] Check whether a GitHub [issue](https://github.com/ejc043/nfcore_fragmentomics/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [ejc043/nfcore_fragmentomics repository](https://github.com/ejc043/nfcore_fragmentomics) to your GitHub account.
...
You can contribute to ejc043/nfcore_fragmentomics without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/ejc043/nfcore_fragmentomics/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the ejc043/nfcore_fragmentomics code and processing logic more understandable for new contributors and to ensure quality.
